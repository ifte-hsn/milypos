            ...
            ->assertJson([
                ...
                "rows" => [
                    [
                        ...
                        "name" => e($client_to_delete->fullName),
                        "first_name" => e($client_to_delete->first_name),
                        "last_name" => e($client_to_delete->last_name),
                        "phone" => e($client_to_delete->phone),
                        "address" => e($client_to_delete->address),
                        "city" => e($client_to_delete->city),
                        "state" => e($client_to_delete->state),
                        "country" => e($client_to_delete->country->name),
                        "zip" => e($client_to_delete->zip),
                    ]
                ]
            ]);
