            ...
            ->assertJson([
                ...
                "rows" => [
                    [
                        "id" => $client->id,
                        "email" => $client->email,
                        "name" => html_entity_decode($client->fullName),
                        "first_name" => html_entity_decode($client->first_name),
                        "last_name" => html_entity_decode($client->last_name),
                        "phone" => html_entity_decode($client->phone),
                        "address" => html_entity_decode($client->address),
                        "city" => html_entity_decode($client->city),
                        "state" => html_entity_decode($client->state),
                        "country" => html_entity_decode($client->country->name),
                        "zip" => html_entity_decode($client->zip),
                        'sex' => html_entity_decode($client->sex),
                        'shopping' => html_entity_decode($client->shopping),
                ...
                [
                    ...
                    "rows" => [
                        [
                            ...
                            "name" => html_entity_decode($clients[3]->fullName),
                            "first_name" => html_entity_decode($clients[3]->first_name),
                            "last_name" => html_entity_decode($clients[3]->last_name),
                            "phone" => html_entity_decode($clients[3]->phone),
                            "address" => html_entity_decode($clients[3]->address),
                            "city" => html_entity_decode($clients[3]->city),
                            "state" => html_entity_decode($clients[3]->state),
                            "country" => html_entity_decode($clients[3]->country->name),
                            "zip" => html_entity_decode($clients[3]->zip),
                        ]
                    ]
                ]
            );
            ...
            ->assertJson([
                ...
                "rows" => [
                    [
                        ...
                        "name" => html_entity_decode($client_to_delete->fullName),
                        "first_name" => html_entity_decode($client_to_delete->first_name),
                        "last_name" => html_entity_decode($client_to_delete->last_name),
                        "phone" => html_entity_decode($client_to_delete->phone),
                        "address" => html_entity_decode($client_to_delete->address),
                        "city" => html_entity_decode($client_to_delete->city),
                        "state" => html_entity_decode($client_to_delete->state),
                        "country" => html_entity_decode($client_to_delete->country->name),
                        "zip" => html_entity_decode($client_to_delete->zip),
                    ]
                ]
            ]);
