...
{
    public function transformProductsForSale(Collection $products, $total) {
        $array = array();
        foreach ($products as $product) {
            $array[] = self::transformProductForSale($product);
        }
    ...
    public function transformProductForSale(Product $product)
    {
        $image = url('/').'/images/products_placeholder.png';
